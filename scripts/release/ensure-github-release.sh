...
assets=(
  "$artifact_directory/beholder-linux-x86_64.tar.gz"
  "$artifact_directory/beholder-linux-arm64.tar.gz"
  "$artifact_directory/beholder-macos-arm64.tar.gz"
  "$artifact_directory/beholder-windows-x86_64.zip"
