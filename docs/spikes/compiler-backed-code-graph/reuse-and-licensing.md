...
| [Sourcetrail](https://github.com/CoatiSoftware/Sourcetrail/blob/master/LICENSE.txt) | GPL-3.0 archived application with language indexers and a custom extension database. | Conceptual and behavioral use only. No implementation dependency. |
